...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConitnue=(Button)findViewById(R.id.btn_Continue);

        btnConitnue.setOnClickListener(new View.OnClickListener() {
            @Override
   ...
   //check session Facebook account Kit
        if(AccountKit.getCurrentAccessToken()!=null){
            final AlertDialog waitingDailog = new SpotsDialog(this);
            waitingDailog.show();
    ...
    private void printKeyHash() {
        try{
            PackageInfo info=getPackageManager().getPackageInfo("com.example.optimas.firebaseconsole",PackageManager.GET_SIGNATURES);

...
import com.example.optimas.firebaseconsole.ViewHolder.ShowCommentViewHolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if(getIntent()!=null)
                    foodId= getIntent().getStringExtra(Common.INTENT_FODD_ID);
                if(!foodId.isEmpty() && foodId!=null)
                {
                    ...
                    adapter = new FirebaseRecyclerAdapter<Rating, ShowCommentViewHolder>(options) {
                        ...
                        protected void onBindViewHolder(@NonNull ShowCommentViewHolder holder, int position, @NonNull Rating model) {
                            ...
                            holder.ratingBar.setRating(Float.parseFloat(model.getRateVlaue()));
